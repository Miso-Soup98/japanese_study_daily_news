...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    h2 {{ font-family:"Yu Mincho","Yu Gothic UI",serif; font-size:25px; line-height:1.75; margin:8px 0 3px; }}
    .meta {{ color:var(--muted); font-size:13px; margin-bottom:18px; }}
    h3 {{ margin:14px 0 6px; font-size:14px; color:var(--muted); }}
    p {{ margin:0; line-height:2; }}
    .ja {{ font-family:"Yu Gothic UI",sans-serif; font-size:18px; }}
    ...
    rt {{ font-size:.48em; color:#5f6d86; font-weight:400; }}
    ...
    @media (max-width:980px) {{ .card {{ grid-template-columns:1fr; }} .study-panel {{ border-left:0; border-top:1px solid #e3e8f2; }} .category-nav .nav-inner {{ display:flex; overflow-x:auto; }} .category-nav a {{ min-width:104px; }} }}
